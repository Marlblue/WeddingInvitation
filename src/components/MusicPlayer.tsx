...
export default function MusicPlayer({ isPlaying, onToggle }: MusicPlayerProps) {
  ...
  return (
    <motion.button
      ...
      onClick={onToggle}
      className={`absolute bottom-20 right-4 z-50 w-10 h-10 rounded-full flex items-center justify-center shadow-lg transition-colors border pointer-events-auto ${
        isPlaying
